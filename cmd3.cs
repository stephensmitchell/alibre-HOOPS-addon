...
public class cmd3 : IAlibreAddOnCommand
{
    ...
    public void On3DRender()
    {
        ...
        Array staticT = staticTransform;
        long seg1 = canvas.AddSubSegment(0, "StaticTriangle");
        canvas.SetSegmentTransform(seg1, true, ref staticT);
        canvas.SetSegmentColor(seg1, 100, 100, 200, 255);
        canvas.DrawMesh(seg1, ref v, ref n, ref i);
        ...
        Array moveT = movingTransform;
        long seg2 = canvas.AddSubSegment(0, "MovingTriangle");
        canvas.SetSegmentTransform(seg2, true, ref moveT);
        canvas.SetSegmentColor(seg2, 200, 100, 0, 255);
        canvas.DrawMesh(seg2, ref v, ref n, ref i);
