...
public class cmd4 : IAlibreAddOnCommand
{
    ...
    public void On3DRender()
    {
        ...
        long s1 = canvas.AddSubSegment(0, "StaticTriangleSegment");
        canvas.SetSegmentTransform(s1, true, ref t1);
        canvas.SetSegmentColor(s1, 100, 100, 255, 255);
        canvas.DrawMesh(s1, ref v, ref n, ref i);
        ...
        long s2 = canvas.AddSubSegment(0, "DynamicTriangleSegment");
